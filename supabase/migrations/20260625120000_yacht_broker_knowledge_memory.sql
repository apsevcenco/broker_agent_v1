...
from (
  ...
  (
    ...
    'internal bootstrap',
    'verified',
    array['yacht-broker','buyer','qualification','confidentiality']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['yacht-broker','seller','mandate','qualification']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['off-market','nda','disclosure','approval']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['broker','cooperation','commission','approval']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['distressed','risk','seller','approval']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['nda','documents','workflow','confidentiality']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['commission','commercial','legal','approval']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['lead-scoring','crm','qualification']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['tone','drafts','luxury','communication']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['asset','yacht-data','inventory']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['memory','relationships','crm','trust']::text[]
  ),
  (
    ...
    'internal bootstrap',
    'verified',
    array['approval','risk','workflow']::text[]
  )
