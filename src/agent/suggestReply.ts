...
const templates: Record<string, string> = {
  "buyer inquiry": "Thank you for your message. Before discussing specific opportunities, I would suggest confirming your acquisition criteria, timeline, target size range, preferred cruising region and proof-of-funds process. Any yacht identity or sensitive detail should remain subject to approval and confidentiality checks.",
